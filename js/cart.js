const createSmallCards = (data) => {
    ...
    <p class="sm-price" data-price="${data.sellPrice}">$${data.sellPrice *
         data.item}</p>
    <button class="sm-delete-btn"><img src="img/close3.gif" alt=""></button>
<div>
    `;
...
let totalBill =0;
    ...
    const setProducts = (name) => {
        ...
        if(data == null){
        element.innerHTML = `<img src="img/no-products.jpg" alt="" class="empty-img">`;
    } else {
